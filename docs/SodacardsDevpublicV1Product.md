...
**Price** | Pointer to [**SodacardsDevpublicV1Money**](SodacardsDevpublicV1Money.md) | price is what the reseller pays, in the currency of Money. It is absent when the item is not  yet priced (listed but not purchasable). | [optional] 
**StrikePrice** | Pointer to [**SodacardsDevpublicV1Money**](SodacardsDevpublicV1Money.md) | strike_price is an optional reference (pre-discount) price, in the currency of Money, for  display. Absent when there is none. | [optional] 
