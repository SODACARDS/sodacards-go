...
------------ | ------------- | ------------- | -------------
**Order** | Pointer to [**SodacardsDevpublicV1PlacedOrder**](SodacardsDevpublicV1PlacedOrder.md) | order is the accepted order. Its status is pending until fulfillment  completes; poll the order to follow it. | [optional] 
