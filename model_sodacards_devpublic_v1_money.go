...
type SodacardsDevpublicV1Money struct {
	...
	// minor_unit_exponent is the currency's number of decimal places (0 for XOF,  2 for USD): amount divided by 10^minor_unit_exponent is the major-unit value.  The example is 0 on purpose: XOF has no minor unit, and an explicit example  keeps the field visible in the docs even though its value is a zero.
